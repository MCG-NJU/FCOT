...
class LaSOTSequence(Sequence):
    """Class for the sequence in an evaluation."""
    def __init__(self, name, frames, ground_truth_rect, absent):
...
class LaSOTDatasetClass(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        fo = np.loadtxt('{}/{}/{}/full_occlusion.txt'.format(self.base_path, class_name, sequence_name),delimiter=',',dtype=np.int)
        ov = np.loadtxt('{}/{}/{}/out_of_view.txt'.format(self.base_path, class_name, sequence_name),delimiter=',',dtype=np.int)
        absent = 1 - np.logical_or(fo, ov)
        
        return LaSOTSequence(sequence_name, frames_list, ground_truth_rect.reshape(-1, 4), absent)
