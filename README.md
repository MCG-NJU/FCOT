...
* [2020.11.29] $\color{red}{**Bug fix:**}$ We will solve the problem soon where the results on VOT2018 are not reproducible. **Notes:** The tracking speed of 47 FPS is evaluated on GOT-10k dataset using a single 2080ti GPU. While due to the difference settings of online training, the tracking speed on other datasets may vary.
